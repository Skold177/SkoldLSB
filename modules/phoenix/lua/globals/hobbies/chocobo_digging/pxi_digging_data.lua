...
-----------------------------------
-- Digging accuracy is effected by players rank only. No moon influence.
-----------------------------------
...
-----------------------------------
-- Areas where Elemental Ores can be dug. Rise of Zilart zones are excluded.
-----------------------------------
...
xi.chocoboDig.nightOnlyItems =
{
    ...
    [xi.item.BAG_OF_TREE_CUTTINGS  ] = true,
...
xi.chocoboDig.zoneTable =
{
    ...
    [xi.zone.EAST_RONFAURE] =
    {
        ...
        { xi.item.BAG_OF_FRUIT_SEEDS,       xi.craftRank.CRAFTSMAN,    25,   35,   70,   95,  120,  145,  170,  170,  170,  170,  170 }, -- Night time only. ☾
    ...
    [xi.zone.EAST_SARUTABARUTA] =
    {
        ...
        { xi.item.BAG_OF_HERB_SEEDS,        xi.craftRank.CRAFTSMAN,    25,   35,   70,   95,  120,  145,  170,  170,  170,  170,  170 }, -- Night time only. ☾
    ...
    [xi.zone.SOUTH_GUSTABERG] =
    {
        ...
        { xi.item.BAG_OF_GRAIN_SEEDS,       xi.craftRank.CRAFTSMAN,    25,   35,   70,   95,  120,  145,  170,  170,  170,  170,  170 }, -- Night time only. ☾
    },
    ...
    [xi.zone.WEST_RONFAURE] =
    {
        ...
        { xi.item.BAG_OF_VEGETABLE_SEEDS,   xi.craftRank.CRAFTSMAN,    25,   35,   70,   95,  120,  145,  170,  170,  170,  170,  170 }, -- Night time only. ☾
    ...
    [xi.zone.WEST_SARUTABARUTA] =
    {
        ...
        { xi.item.BAG_OF_TREE_CUTTINGS,     xi.craftRank.CRAFTSMAN,    25,   35,   70,   95,  120,  145,  170,  170,  170,  170,  170 }, -- Night time only. ☾
    },
