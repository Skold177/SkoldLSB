...
-- If Firespit or Stave Toss are chosen, unhide gate and redirect target to it - the exit state listener will rehide it.
entity.onMobSkillTarget = function(target, mob, skill)
    ...
    if
        skill == xi.mobSkill.STAVE_TOSS_1 or
        skill == xi.mobSkill.FIRESPIT_BLUE_MAMOOLJA
    then
...
entity.onMobSpellChoose = function(mob, target, spellId)
    local spellList =
    {
        ...
        [ 6] = { xi.magic.spell.HASTE,        mob,    true,  xi.action.type.ENHANCING_TARGET,     xi.effect.HASTE,       0, 100 },
        ...
        [11] = { xi.magic.spell.DIAGA_II,     target, false, xi.action.type.ENFEEBLING_TARGET,    xi.effect.DIA,         2, 100 },
        [12] = { xi.magic.spell.SLOW,         target, false, xi.action.type.ENFEEBLING_TARGET,    xi.effect.SLOW,        0, 100 },
