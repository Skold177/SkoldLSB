...
xi.quest.id =
{
    ...
    [xi.quest.area[xi.questLog.SANDORIA]] =
    {
        ...
        CHASING_QUOTAS                  = 95, -- + Converted
        KNIGHT_STALKER                  = 96, -- +
        ECO_WARRIOR                     = 97, -- + Converted
    ...
    [xi.quest.area[xi.questLog.WINDURST]] =
    {
        ...
        IN_A_PICKLE                     = 5,  -- +
        WONDERING_MINSTREL              = 6,  -- + Converted
    ...
    [xi.quest.area[xi.questLog.JEUNO]] =
    {
        ...
        THE_REQUIEM                     = 64, -- + Converted
        THE_CIRCLE_OF_TIME              = 65, -- + Converted
        ...
        ALL_IN_THE_CARDS                = 166, -- + Converted
    ...
    [xi.quest.area[xi.questLog.OUTLANDS]] =
    {
        ...
        I_LL_TAKE_THE_BIG_BOX           = 144, -- + Converted
        TRUE_WILL                       = 145, -- +
