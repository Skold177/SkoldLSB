...
xi.data.effectMap.key =
{
    ...
    -- En-Spell
    [xi.magic.spell.ENAERO       ] = { 1, xi.effect.ENAERO,        xi.effect.ENAERO_II     },
    [xi.magic.spell.ENBLIZZARD   ] = { 1, xi.effect.ENBLIZZARD,    xi.effect.ENBLIZZARD_II },
    [xi.magic.spell.ENFIRE       ] = { 1, xi.effect.ENFIRE,        xi.effect.ENFIRE_II     },
    [xi.magic.spell.ENSTONE      ] = { 1, xi.effect.ENSTONE,       xi.effect.ENSTONE_II    },
    [xi.magic.spell.ENTHUNDER    ] = { 1, xi.effect.ENTHUNDER,     xi.effect.ENTHUNDER_II  },
    [xi.magic.spell.ENWATER      ] = { 1, xi.effect.ENWATER,       xi.effect.ENWATER_II    },
    [xi.magic.spell.ENAERO_II    ] = { 2, xi.effect.ENAERO_II,     xi.effect.ENAERO        },
    [xi.magic.spell.ENBLIZZARD_II] = { 2, xi.effect.ENBLIZZARD_II, xi.effect.ENBLIZZARD    },
    [xi.magic.spell.ENFIRE_II    ] = { 2, xi.effect.ENFIRE_II,     xi.effect.ENFIRE        },
    [xi.magic.spell.ENSTONE_II   ] = { 2, xi.effect.ENSTONE_II,    xi.effect.ENSTONE       },
    [xi.magic.spell.ENTHUNDER_II ] = { 2, xi.effect.ENTHUNDER_II,  xi.effect.ENTHUNDER     },
    [xi.magic.spell.ENWATER_II   ] = { 2, xi.effect.ENWATER_II,    xi.effect.ENWATER       },
}
